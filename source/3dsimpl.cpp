...
bool impl3dsInitialize()
{
	...
	const SGPUTextureConfig vramTexConfig[] = {
		...
		{ defaultTextureParams, SNES_MOSAIC_SCRATCH, GPU_RGBA8, 256, 256 }, // mosaic scratch — must be in Bank A before 2MB Mode7 texture
	...
	// Must run after ALL vram textures are allocated.
	{
		...
		setDepthBufferByTex(GPU3DS.textures[SNES_MOSAIC_SCRATCH].target, depthTex);
	}
