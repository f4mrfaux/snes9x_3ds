...
bool impl3dsInitialize()
{
	...
	const SGPUTextureConfig vramTexConfig[] = {
		...
		{ defaultTextureParams, SNES_MAIN_R, GPU_RGBA8, 256, 256 }, // stereo right eye — same format as SNES_MAIN
	...
	// Must run after ALL vram textures are allocated (SNES_MAIN_R is last).
	{
